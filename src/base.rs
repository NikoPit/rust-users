...
pub mod os {
    ...
    #[cfg(any(target_os = "linux", target_os = "android", target_os = "macos", target_os = "freebsd", target_os = "dragonfly", target_os = "openbsd", target_os = "netbsd", target_os = "solaris", target_os = "seele"))]
    pub mod unix {
        ...
        #[cfg(any(target_os = "linux", target_os = "android", target_os = "solaris", target_os = "seele"))]
